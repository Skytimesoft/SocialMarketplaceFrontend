<template>
  <div class="">
    ...
    <!-- Breadcrumb -->
    <nav
      class="relative mt-10 flex px-5 py-3 text-gray-700 rounded-md border border-slate-300 bg-gradient-to-l from-red-50 to-slate-50 dark:bg-gray-800 dark:border-gray-700"
      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li aria-current="page">
          <div class="flex items-center">
            ...
            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400 capitalize">{{ $route.name }}</span>
          </div>
        </li>
      </ol>
