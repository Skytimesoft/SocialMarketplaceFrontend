<template>
    <nav class="relative mt-10 flex px-5 py-3 text-gray-700 rounded-md border border-slate-300 bg-gradient-to-l from-red-50 to-slate-50 dark:bg-gray-800 dark:border-gray-700"
        ...
        <div class="absolute hidden lg:flex rotate-180 top-full left-20 h-8 items-end overflow-hidden">
